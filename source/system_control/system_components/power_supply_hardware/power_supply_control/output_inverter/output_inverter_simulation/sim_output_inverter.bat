...
ghdl -a --ieee=synopsys tb_output_inverter.vhd
ghdl -e --ieee=synopsys tb_output_inverter
ghdl -r --ieee=synopsys tb_output_inverter --vcd=tb_output_inverter.vcd


IF %1 EQU 1 start "" gtkwave tb_output_inverter.vcd
